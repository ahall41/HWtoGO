...
class HWReader {
    ...
    private static $maps=
        ["Combination"=>[	
                ...
                "g"=>"LeftXPosPixels",
                "h"=>"TopYPosPixels",
                "j"=>"RightXPosPixelsIfTiling",
                "k"=>"BottomYPosPixelsIfTiling",
                "l"=>"AlternateScreenLayout1_ImageSetID",
                "m"=>"AlternateScreenLayout1_LeftXPosPixels",
                "n"=>"AlternateScreenLayout1_TopYPosPixels",
                "o"=>"AlternateScreenLayout1_RightXPosPixelsIfTiling",
