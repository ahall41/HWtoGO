...
class SzikszoOriginal extends AVOrgan {
    ...
    protected $patchEnclosures=[
        220=>[                     "Name"=>"Pos",   "GroupIDs"=>[301,302], "InstanceID"=>52],
        230=>[                     "Name"=>"Swell", "GroupIDs"=>[401,402], "InstanceID"=>54],
         11=>["EnclosureID"=>"11", "Name"=>"Far",   "GroupIDs"=>[101,201,301,401], "InstanceID"=>85134, "AmpMinimumLevel"=>0],
         12=>["EnclosureID"=>"12", "Name"=>"Near",  "GroupIDs"=>[102,202,302,402], "InstanceID"=>85132, "AmpMinimumLevel"=>0],
    ];
     ...
     * Run the import
     */
    public static function SzikszoOriginal() {
...
SzikszoOriginal::SzikszoOriginal();
