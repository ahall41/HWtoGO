...
class SwietaLipka extends PGOrgan {
    ...
    protected $patchStops=[
        ...
        3093=>["StopID"=> 3093, "DivisionID"=>1, "Name"=>"Nachtigall (rear)",   "ControllingSwitchID"=>53,   "Engaged"=>"N", "Ambient"=>TRUE, "GroupID"=>804],
          ...
          95=>["StopID"=>   95, "DivisionID"=>1, "Name"=>"Zimbelstern (close)", "ControllingSwitchID"=>55,   "Engaged"=>"N", "Ambient"=>TRUE, "GroupID"=>801],
        1095=>["StopID"=> 1095, "DivisionID"=>1, "Name"=>"Zimbelstern (front)", "ControllingSwitchID"=>55,   "Engaged"=>"N", "Ambient"=>TRUE, "GroupID"=>802],
        2095=>["StopID"=> 2095, "DivisionID"=>1, "Name"=>"Zimbelstern (middle)","ControllingSwitchID"=>55,   "Engaged"=>"N", "Ambient"=>TRUE, "GroupID"=>803],
        3095=>["StopID"=> 3095, "DivisionID"=>1, "Name"=>"Zimbelstern (rear)",  "ControllingSwitchID"=>55,   "Engaged"=>"N", "Ambient"=>TRUE, "GroupID"=>804],
