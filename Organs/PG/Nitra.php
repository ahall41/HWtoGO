...
class Nitra extends PGOrgan {
    ...
    protected $patchStops=[
        ...
        2094=>["StopID"=> 2094, "DivisionID"=>1, "Name"=>"Cuculus (rear)",      "ControllingSwitchID"=>35,   "Engaged"=>"N", "Ambient"=>TRUE, "GroupID"=>803],
          95=>["StopID"=>   95, "DivisionID"=>1, "Name"=>"Pauke (close)",       "ControllingSwitchID"=>38,   "Engaged"=>"N", "Ambient"=>TRUE, "GroupID"=>801],
        1095=>["StopID"=> 1095, "DivisionID"=>1, "Name"=>"Pauke (front)",       "ControllingSwitchID"=>38,   "Engaged"=>"N", "Ambient"=>TRUE, "GroupID"=>802],
        2095=>["StopID"=> 2095, "DivisionID"=>1, "Name"=>"Pauke (rear)",        "ControllingSwitchID"=>38,   "Engaged"=>"N", "Ambient"=>TRUE, "GroupID"=>803],
    ...
    /* Samples are
     * 8706/18127/27548 036-c.wav (ambience?)
     * 8707/18128/27549 037-c#.wav 
     * 8708/18129/27550 038-d.wav
     * 8709/18130/27551 038-d#.wav
     * 8710/18131/27552 040-e.wav
     */
    public function processNoise(array $hwdata, bool $isattack): ?\GOClasses\Noise {
        $method=$isattack ? "configureAttack" : "configureRelease";
        $hwdata["SampleFilename"]=$fn=$this->sampleFilename($hwdata);
        // if (strpos($fn,"Noises/A0")!==FALSE) print_r($hwdata);
