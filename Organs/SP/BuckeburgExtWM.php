...
/**
 * Model of the Whittington Moor Organ, based on Buckeburg sammples
 * 
 * @author andrew`
 */
class BuckeburgExtWM extends \Import\Organ {
    ...
    private $couplers=[
       301=>["Name"=>"Gt/Ped",    "SourceKeyboardID"=>0, "DestKeyboardID"=>1, "Position"=>[7, 3]],
       302=>["Name"=>"Sw/Ped",    "SourceKeyboardID"=>0, "DestKeyboardID"=>2, "Position"=>[8, 3]],
       304=>["Name"=>"Sw +8/Gt",  "SourceKeyboardID"=>1, "DestKeyboardID"=>2, "Position"=>[6, 4], "MIDINoteNumberIncrement"=>12],
       303=>["Name"=>"Sw/Gt",     "SourceKeyboardID"=>1, "DestKeyboardID"=>2, "Position"=>[7, 4]],
       305=>["Name"=>"Sw -8/Gt",  "SourceKeyboardID"=>1, "DestKeyboardID"=>2, "Position"=>[8, 4], "MIDINoteNumberIncrement"=>-12],
       306=>["Name"=>"Sw Sup",    "SourceKeyboardID"=>2, "DestKeyboardID"=>2, "Position"=>[4, 3], "MIDINoteNumberIncrement"=>12],
       307=>["Name"=>"Sw Sub",    "SourceKeyboardID"=>2, "DestKeyboardID"=>2, "Position"=>[4, 4], "MIDINoteNumberIncrement"=>-12],
       308=>["Name"=>"Gt Sup",    "SourceKeyboardID"=>1, "DestKeyboardID"=>1, "Position"=>[4, 1], "MIDINoteNumberIncrement"=>12],
       309=>["Name"=>"Gt Sub",    "SourceKeyboardID"=>1, "DestKeyboardID"=>1, "Position"=>[4, 2], "MIDINoteNumberIncrement"=>-12],
    ];
    
    private $stops=[
        20=>["ManualID"=>1, "DivisionID"=>1, "Position"=>[1, 1], "TremulantID"=>1, "Name"=>"Diapason 8'"],
        13=>["ManualID"=>1, "DivisionID"=>1, "Position"=>[2, 1], "TremulantID"=>1, "Name"=>"St Diapason 8'"],
        12=>["ManualID"=>1, "DivisionID"=>1, "Position"=>[3, 1], "TremulantID"=>1, "Name"=>"Dulciana 8'"],
        21=>["ManualID"=>1, "DivisionID"=>1, "Position"=>[2, 2], "TremulantID"=>1, "Name"=>"Principal 4'"],
        33=>["ManualID"=>1, "DivisionID"=>1, "Position"=>[3, 2], "TremulantID"=>1, "Name"=>"Flute 4'"],

         1=>["ManualID"=>0, "DivisionID"=>0, "Position"=>[6, 1], "Name"=>"Bourdon 16'"],
        42=>["ManualID"=>0, "DivisionID"=>0, "Position"=>[7, 1], "Name"=>"Bass 8'"],
        43=>["ManualID"=>0, "DivisionID"=>0, "Position"=>[7, 2], "Name"=>"Octave 4'"],

        17=>["ManualID"=>2, "DivisionID"=>2, "Position"=>[2, 3], "TremulantID"=>1, "Name"=>"Horn 8'"],
        26=>["ManualID"=>2, "DivisionID"=>2, "Position"=>[3, 3], "TremulantID"=>1, "Name"=>"Principal 4'"], 
        31=>["ManualID"=>2, "DivisionID"=>2, "Position"=>[1, 4], "TremulantID"=>1, "Name"=>"Gamba 8'"],
        32=>["ManualID"=>2, "DivisionID"=>2, "Position"=>[2, 4], "TremulantID"=>1, "Name"=>"Gedackt 8'"],
        25=>["ManualID"=>2, "DivisionID"=>2, "Position"=>[3, 4], "TremulantID"=>1, "Name"=>"Diapason 8'"],
    ];
    ...
    protected function buildOrgan() : void {
        ...
        $general["Name"]="Whittington Moor (Buckeburg Model)";
        $general["PanelID"]=0;
     ...
     * Run the build
     */
    public static function BuckeburgExtWM(array $positions=[], string $target="") {
        if (sizeof($positions)>0) {
            $hwi=new BuckeburgExtWM(self::ROOT . self::SOURCE);
            $hwi->positions=$positions;
            $hwi->build();
            $hwi->getOrgan()->ChurchName=$hwi->getPanel(0)->Name="Whittington Moor (Buckeburg Model - $target)";
